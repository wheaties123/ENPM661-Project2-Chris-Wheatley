...
startInObstacle = obstacleCheckRigid(Obstacles,start_node);
goalInObstacle = obstacleCheckRigid(Obstacles,goal_node);
...
if startInObstacle==1
    ...
    while outside_obs_start==1
        ...
        start_node = input(prompt);
        outside_obs_start = obstacleCheckRigid(Obstacles,start_node);
    end
end
...
if goalInObstacle==1
    ...
    while outside_obs_start==1
        ...
        outside_obs_goal = obstacleCheckRigid(Obstacles,goal_node);
    end
end
...
while goal_node_explored==0
    ...
    if and(Nodes(i).x==0,Nodes(i).y==0)==1
        ...
        outside_obs_goal = obstacleCheckRigid(Obstacles,[x,y]);
